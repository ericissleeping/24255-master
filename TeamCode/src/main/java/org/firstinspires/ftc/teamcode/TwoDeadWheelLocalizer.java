...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2957.4105452529693; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 23.89161239367338; // x position of the perpendicular encoder (in tick units)
    }
...
//        par = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "par0")));
        par = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "liftRight")));
